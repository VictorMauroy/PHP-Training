...
and moreover 50 new inhabitants per year come to live in the town. How many years does the town need to see its population greater than or equal to p = 1200 inhabitants?
...
function nbYear($p0, $percent, $aug, $p) {
    ...
    for($i = $p0; 
        $i < $p; 
        $i = floor($i + $i * $percent / 100 + $aug), $num_years++
    ) {}
    return $num_years;
}
